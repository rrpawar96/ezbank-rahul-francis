...
@Service
@CommandType(entity = "RETAILACCOUNTENTRIES", action = "CREATE")
public class CreateRetailAccountEntriesCommandHandler implements NewCommandSourceHandler {
	
	private RetailAccountEntryWritePlatformService retailAccountEntryWritePlatformService;
	
	  @Autowired
	    public CreateRetailAccountEntriesCommandHandler(
	    ...
	    public CommandProcessingResult processCommand(final JsonCommand command) {
	        return this.retailAccountEntryWritePlatformService.addEntries(command.entityId(), command);
	    }
